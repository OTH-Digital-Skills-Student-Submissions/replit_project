...
Tippe auf den Knopf **Import from GitHub** und füge im Feld **GitHub Url** folgenden Link ein: [https://github.com/OTH-Digital-Skills/replit_project](https://github.com/OTH-Digital-Skills/replit_project). Starte daraufhin den **Import**.

![IMPORT_FROM_GITHUB](node_modules/assets/import_from_github.jpg)
...
![GITHUB_SSH_KEY](node_modules/assets/github_ssh_key.jpg)
